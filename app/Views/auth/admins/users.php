...
<?= $this->section('main') ?>
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="card mt-3">
          <div class="card-body">
            <h5 class="card-title">This month Registed Users</h5>
            <h3 class="card-text"><?= $newusers ?></h3>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-outline-danger btn-sm" href="<?= site_url('users/delete/').$item['id'] ?>" onclick="return confirm('Are sure you to delete the user?')"><i class="fas fa-trash"></i> Delete</a>
                        </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
